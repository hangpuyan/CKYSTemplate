...
@implementation HPNetworkErrorView {
    __weak id<HPNetworkErrorViewDelegate> _delegate;
}
...
- (instancetype)initWithFrame:(CGRect)frame parentView:(UIView *)parentView {
    ...
    if (self) {
        ...
        self.imageViewCenter.image = [UIImage imageNamed:@"hp_network_error_image_placeholder"];
