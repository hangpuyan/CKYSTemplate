...
#define HP_A_CELL_BG_COLOR      [UIColor whiteColor]
...
- (void)initUI {
    self.backgroundColor = HP_A_CELL_BG_COLOR;
    _imageViewCenter = [[UIImageView alloc] initWithImage:[UIImage imageNamed:HP_A_IMAGE_PLACEHOLDER]];
