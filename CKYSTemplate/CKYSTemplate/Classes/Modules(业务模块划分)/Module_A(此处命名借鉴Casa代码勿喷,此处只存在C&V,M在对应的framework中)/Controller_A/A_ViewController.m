...
+ (void)jumpToSourceCenterMinePageFromViewController:(UIViewController *)viewController authorId:(NSString *)authorId {
    [viewController.navigationController pushViewController:[[A_ViewController alloc] initWithAuthorId:authorId] animated:YES];
}
