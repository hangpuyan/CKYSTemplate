...
#define CKYS_SOURCE_CENTER_VIDEO_BUTTON_IMAGE_NORMAL @"ckys_source_center_video_control_button_image_normal"
#define CKYS_SOURCE_CENTER_VIDEO_BG_COLOR [UIColor colorWithRed:231/255.0 green:231/255.0 blue:231/255.0 alpha:0.8]
...
- (void)initUI {
    ...
    self.backgroundColor = CKYS_SOURCE_CENTER_VIDEO_BG_COLOR;
    ...
    _buttonVideoControl = [UIButton buttonWithImageNormalString:CKYS_SOURCE_CENTER_VIDEO_BUTTON_IMAGE_NORMAL imageHilightString:CKYS_SOURCE_CENTER_VIDEO_BUTTON_IMAGE_NORMAL imageDisenabledString:CKYS_SOURCE_CENTER_VIDEO_BUTTON_IMAGE_NORMAL imageBgNormalString:@"" imageBgHilightString:@"" imageBgDisenabledString:@"" backgroundColor:nil tag:0 rect:CGRectZero targrt:self action:@selector(private_sourceCenterVideoViewButtonVideoControlAction:) forControlEvents:UIControlEventTouchUpInside];
